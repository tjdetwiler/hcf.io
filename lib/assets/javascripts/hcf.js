...
require.define("/src/dcpu.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
  ...
  Dcpu16 = (function() {
    ...
    Dcpu16.prototype.onInstrUndefined = function(fn) {
      return this.mInstrUndefinedCb = fn;
    };
    ...
    Dcpu16.prototype.step = function() {
      ...
      if (!i.valid()) {
        if (this.mInstrUndefinedCb != null) this.mInstrUndefinedCb(this, i);
        return;
      }
      if (this.mPendingIrq) {
      ...
      if (this.mPreExecCb != null) this.mPreExecCb(this, i);
      this.exec(i);
      if (this.mPostExecCb != null) this.mPostExecCb(this, i);
      while (this.mCCFail) {
        i = new Instr(this.mIStream);
        this.mCCFail = i.cond();
        if (this.mCondFailCb != null) this.mCondFailCb(this, i);
      }
      return this.mDecoded = new Instr(this.mIStream);
    };
...
require.define("/src/dcpu-decode.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
...
require.define("/src/dcpu-disasm.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
...
require.define("/src/dcpu-asm.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
  ...
  Assembler = (function() {
    ...
    Assembler.prototype.lpDat = function(match) {
      var c, n, tok, toks, _i, _j, _len, _len2, _ref, _results;
      toks = match[1].split(",");
      _results = [];
      for (_i = 0, _len = toks.length; _i < _len; _i++) {
        ...
        if (match = tok.match(Assembler.str_regex)) {
          ...
          for (_j = 0, _len2 = _ref.length; _j < _len2; _j++) {
            c = _ref[_j];
            this.out(new Data(this, c.charCodeAt(0)));
          }
        } else if ((n = parseInt(tok)) != null) {
          this.out(new Data(this, n));
        } else {
...
require.define("/src/hw/device.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
  var Device, Module;
...
require.define("/src/hw/lem1802.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
...
require.define("/src/hw/generic-clock.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
...
require.define("/src/hw/generic-keyboard.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
...
require.define("/index.coffee", function (require, module, exports, __dirname, __filename) {
  ...
  if (typeof window !== "undefined" && window !== null) window.hcf = exports;
